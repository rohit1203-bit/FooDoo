...
public class AdapterShop extends RecyclerView.Adapter<AdapterShop.HolderShop>{
    ...
    public void onBindViewHolder(@NonNull HolderShop holder, int position) {
        ...
        holder.phoneTv001.setText(Phone );
        ...
        try {
            ...
            holder.shopIv.setImageResource(R.drawable.ic_store_grey);           //34:02
        }

        //handel click lidtener ,show shop details
    ...
    class HolderShop extends RecyclerView.ViewHolder {
        ...
        // ui views of roe_shop.xml
        private ImageView shopIv, onlineIv;
        private TextView shopClosedTv, shopNameTv, phoneTv001, addressTv;
        ...
        public HolderShop(@NonNull View itemView) {
            ...
            phoneTv001 = itemView.findViewById(R.id.phoneTv001);
