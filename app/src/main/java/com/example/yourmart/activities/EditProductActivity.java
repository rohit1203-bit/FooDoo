...
public class EditProductActivity extends AppCompatActivity {
    ...
    private void updateProduct() {
        ...
        if(image_uri01==null){
            ...
            //image name and path on firebase storage
               ...
               storageReference.putFile(image_uri01)
    ...
    private void pickFromCamera(){
        ...
        image_uri01 = getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, contentValues);

        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intent.putExtra(MediaStore.EXTRA_OUTPUT, image_uri01);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(resultCode==RESULT_OK){
            if(requestCode==IMAGE_PICK_GALLERY_CODE){
                image_uri01=data.getData();
                productIconIv.setImageURI(image_uri01);
