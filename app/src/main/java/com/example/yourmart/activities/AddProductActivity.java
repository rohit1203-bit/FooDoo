...
public class AddProductActivity extends AppCompatActivity {
    private ImageView productIconIvseller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productIconIvseller = findViewById(R.id.productIconIvseller);
        ...
        productIconIvseller.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void clearData(){
        ...
        productIconIvseller.setImageResource(R.drawable.ic_add_shopping_primary);
        //image_uri = null;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(resultCode==RESULT_OK){
            if(requestCode==IMAGE_PICK_GALLERY_CODE){
                ...
                productIconIvseller.setImageURI(image_uri);
