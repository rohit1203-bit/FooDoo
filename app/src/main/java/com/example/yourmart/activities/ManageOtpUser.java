...
public class ManageOtpUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_otp_user);

        phonenumber11=getIntent().getStringExtra("mobile").toString();
    ...
    private void initiateotp()
    {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                phonenumber11,        // Phone number to verify
                60,                 // Timeout duration
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            startActivity(new Intent(ManageOtpUser.this, MainUserActivity.class));
